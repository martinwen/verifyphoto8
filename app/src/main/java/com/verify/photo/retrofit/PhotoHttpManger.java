...
import com.verify.photo.api.PhotoApi;
import com.verify.photo.config.Constants;
import com.verify.photo.retrofit.convert.FastJsonConverterFactory;
import com.verify.photo.retrofit.interceptor.HeaderInterceptor;
import com.verify.photo.retrofit.interceptor.LoggerInterceptor;
