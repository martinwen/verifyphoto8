...
import com.shcy.yyzzj.activity.CameraUtil;
...
import com.shcy.yyzzj.module.soundplayer.SoundPlayer;
...
import static com.shcy.yyzzj.module.selectsize.SelectSizeActivity.IMAGEPATH;
...
//                mCamera.stopPreview();
    ...
    private File getOutputMediaFile() {
        File tempFile1 = new File(Environment.getExternalStorageDirectory()
                ...
                + "yyzzj" : Environment.getExternalStorageDirectory()
                .getAbsolutePath() + "/yyzzj");
